...
import com.pwp.activity.convertdate.MyCalendarConvertView;
import com.pwp.activity.myschedule.ScheduleAddView;
import com.pwp.activity.myschedule.ScheduleAllView;
import com.pwp.activity.myschedule.ScheduleInfoView;
...
public class MyCalendarView extends Activity implements OnGestureListener,
	...
	private ScheduleDBHelp mScheduleDBHelp = null;
	...
	public MyCalendarView() {
		...
		mScheduleDBHelp = new ScheduleDBHelp(this);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAdp = new MyCalendarAdp(this, getResources(), jumpMonth, jumpYear,
	...
	public void addTopTextView(TextView textView) {
		...
		textDate.append(mAdp.getShowYear()).append("年")
				.append(mAdp.getShowMonth()).append("月").append("<br>");
		...
		textView.setText(Html.fromHtml(textDate.toString()));
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				if (startPosition <= position && position <= endPosition) {
					...
					String[] scheduleIDs = mScheduleDBHelp
							.getScheduleByTagDate(
